...
Init0_CFILES += $(wildcard $(SOURCE_DIR)/cma34cr_centos/src/*.c) \
...
${STAGE_DIR}/${KERNEL_FILENAME}: $(SOURCE_DIR)/cma34cr_centos/${KERNEL_FILENAME}
	@echo "[EXTRACT-VMLINUX] $@"
	$(Q)mkdir -p $(@D)
	${PWD}/tools/elf/extract-vmlinux $< > $@

${STAGE_DIR}/${ROOTFS_FILENAME}: ${SOURCE_DIR}/cma34cr_centos/${ROOTFS_FILENAME}
	@echo "[CP] $@"
	@cp $< $@
